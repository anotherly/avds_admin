...
if(null != report_key){
	...
	//ExportInfo exportInfo = ClipReportExport.createExportForPartHTML5Print(request, report_key, fileStream, "UTF-8", script);
		
	ExportInfo exportInfo = ClipReportExport.createExportForPartHTML5Print(request, report_key, fileStream, "UTF-8", script, propertyPath);
