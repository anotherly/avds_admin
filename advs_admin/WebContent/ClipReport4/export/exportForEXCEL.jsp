...
excelOption.setRemoveHyperlink(false);
/*엑셀 파일에 들어가는 이미지의 dpi 설정*/
excelOption.setImageDPI(150);

/* 페이지 머리글/바닥글 반복
하나의 시트(페이지 영역 무시) , 리포트마다 (페이지 영역 무시) 일 경우에만 적용*/
excelOption.setRepeatPageSectionWhenAllSectionInOneSheet(false);
