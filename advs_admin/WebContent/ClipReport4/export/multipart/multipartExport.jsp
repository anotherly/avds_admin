...
ExportStatusInfo exportStatus = ClipReportExport.runEnginge(request, propertyPath, oof);
//ExportStatusInfo exportStatus = ClipReportExport.EngingeRunByStorage(request, propertyPath, oof, "rpt2");
...
//서버에 지정 폴더 저장 할 때
String fileName = "c:\\temp1\\report.jpg";
