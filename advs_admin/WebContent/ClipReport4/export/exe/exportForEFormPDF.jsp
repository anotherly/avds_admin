...
boolean isbase64Encoding = isBase64.toUpperCase().equals("TRUE");
//데이터가 인코딩이 안되어있을 때
...
if(null != eform_data){
	//서버에 파일로 저장 할 때
	String fileName = "C:\\Temp1\\Test\\" + eform_key + ".pdf";
	//String fileName = "c:\\temp1\\test\\report.pdf";
	...
	*/
	...
	response.getWriter().write(String.valueOf(errorCode));
