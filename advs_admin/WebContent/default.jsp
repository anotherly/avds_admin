...
<body>
<script language="javascript"><%=scriptMsg%>
</script>

사용자:<%=logonId %><br/>
사용자 속성<br/><%=userInfo%><br/><br/>
<input type="button" value="로그오프" onclick="OnLogoff();"/><br><br/>
<a href="webToApp.jsp">ESSO 인증 연계</a><br><br/>
<a href="http://nsso.wow.ca:8080/nsso-authweb/trust/sendsso.do?AudienceID=sso.seah.co.kr&returnURL=http%3a%2f%2fportal.seah.co.kr%2fSSO%2fClient%2fDefault.aspx">NSSO TRUST to NSSOD</a>
</body>
</html>
<%
