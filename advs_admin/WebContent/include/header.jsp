...
<link rel="stylesheet" href="<c:url value='/new/resource/css/lib/simplebar.css' />" type="text/css"/>
<link rel="stylesheet" href="<c:url value='/new/resource/css/sub__manage.css' />" type="text/css"/>
<link rel="stylesheet" href="<c:url value='/new/resource/css/ux-admin.css' />" type="text/css"/>

<script type="text/javascript" src="<c:url value='/js/jquery-3.3.1.js' />"></script>
<script type="text/javascript" src="<c:url value='/new/resource/js/jquery-3.6.0.min.js' />"></script>
<script type="text/javascript" src="<c:url value='/js/jquery-ui-1.12.1.custom/jquery-ui.js' />"></script>
<script type="text/javascript" src="<c:url value='/js/jquery-ui-1.12.1.custom/datepicker-ko.js' />"></script>
...
<script type="text/javascript" src="<c:url value='/js/lib/simplebar.js' />" type="text/javascript"></script>
<script type="text/javascript" src="<c:url value='/js/header.js' />" type="text/javascript"></script>
