...
$(document).ready(function() {
	commonMakeWebMenuComboBox("sMenuPrntId", true);
	
	commonMakeCodeComboBox("leafYn", "YN_CODE1");
	commonMakeCodeComboBox("useYn", "YN_CODE2");
	commonMakeCodeComboBox("scriptYn", "YN_CODE2");
...
function fn_search(selectNode) {
	...
	commonAjax(searchData, "/system/webMenu/selectMenuList.do", function(returnData, textStatus, jqXHR) {
...
function fn_searchForm(nodeId) {
	commonAjax({ "sMenuId": nodeId }, "/system/webMenu/selectMenuList.do", function(returnData, textStatus, jqXHR) {
		...
		$("#scriptYn").val(formData.scriptYn);
		$("#scriptMethod").val(formData.scriptMethod);
...
function fn_save() {
	...
	commonAjax(data ,"/system/webMenu/transactionMenu.do" , function(returnData, textStatus, jqXHR) {		
...
<div class="wrap p-20 h-100">
	<div class="float_left w100p jj posi_r">
	...
	<div class="lay-boxItem lay-item--full grids__col-12 m-0" style="overflow: auto;height:calc(100% - 90px);">
		<div class="boxItem__inner h-100">
			<div class="d-flex h-100 flex-wrap">
				<div id="tree" class="float_left" style="overflow:auto;width: 50%; height: 100%; border: 1px solid #e8eef1;  border-radius: 3px; background: #fff; padding: 10px;">
					<div id="jsTree" style="overflow: auto; width: 100%; height: 100%;"></div>
				</div>
				
				<div id="form" style="overflow:auto;width: calc(50% - 10px); height: 100%; border: 1px solid #e8eef1; border-radius: 3px; background: #fff; padding: 10px; margin-left: 10px;">
					<form id="detailForm" name="detailForm" method="post">
						...
						<div class="el-table-wrap">
							<table class="el-table  el-table--row el-table--menuManage" >
								<caption></caption>
								<colgroup>
									<col width="30%" />
									<col width="*%" />
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuId" name="menuId" value="" caption="메뉴ID" required="required"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuNm" name="menuNm" value="" caption="메뉴명" required="required"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuPrntId" name="menuPrntId" value="" caption="상위메뉴ID" required="required"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="dispOrdr" name="dispOrdr" value="" caption="메뉴순서" required="required"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuObject" name="menuObject" value="" caption="메뉴대상"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuPath" name="menuPath" value="" caption="메뉴경로"/>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="iconNm" name="iconNm" value="" caption="대메뉴아이콘"/>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="menuLevel" name="menuLevel" value="" caption="메뉴레벨"/>
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<div class="el-form custom-sel">
												<select class="el-form__sel" id="scriptYn" name="scriptYn" caption="스크립트사용여부" required="required"></select>
											</div>
										</td>
									</tr>		
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--full" id="scriptMethod" name="scriptMethod" value="" caption="스크립트명"/>
											</div>
										</td>
									</tr>								
									<tr>
