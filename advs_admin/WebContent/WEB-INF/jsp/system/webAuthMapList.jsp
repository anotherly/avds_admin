...
function fn_searchTree() {
	...
	commonAjax(null, "/system/webMenu/selectMenuList.do", function(returnData, textStatus, jqXHR) {
...
function fn_checkTree(rowId) {
	...
	commonAjax({ "authId": rowData.authId }, "/system/webAuthMap/selectAuthMapList.do", function(returnData, textStatus, jqXHR) {
...
function fn_save() {
	...
	commonAjax(data ,"/system/webAuthMap/transactionAuthMap.do" , function(returnData, textStatus, jqXHR) {
...
<div class="wrap p-20 h-100">
	<div class="float_left w100p ii posi_r">
			...
			<div class="d-flex align-center posi_r">
				<fieldset class="d-flex align-center">
					...
					<div class="el-form custom-input ml-10">
						<input type="text" class="el-form__input el-form-width--l" id="sAuthNm" name="sAuthNm" value="" onkeypress="if(event.keyCode==13) {fn_search(); return false;}"/>
					</div>
		    	</fieldset>
	...
	<div class="lay-boxItem lay-item--full grids__col-12 m-0" style="overflow: auto;height:calc(100% - 90px);">
		<div class="boxItem__inner h-100">
			<div class="d-flex h-100 flex-wrap">
				<div id="grid" class="float_left ov-auto-y ov-hidden-x" style="width: calc(50% - 10px); height: 100%; border: 1px solid #e8eef1;  border-radius: 3px; background: #fff; padding: 10px;">
					<table id="gridList" class="word_b"></table>
				</div>
			
				<div id="tree" style="overflow:auto;width: 50%; height: 100%; float: left; border: 1px solid #e8eef1; border-radius: 3px; background: #fff; padding: 10px; margin-left: 10px;">
