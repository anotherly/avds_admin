										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													&nbsp;&nbsp;<input type="button" style="width: 80px; height: 25px; vertical-align: bottom;" id="btnInsdateHis" name="btnInsdateHis" onclick="javascript:fn_insdateHis();" value="이력보기" />
												</td>
											</tr>
											<tr>
												<th>변경보험가입일자</th>
												<td><input type="text" style="width: 100px; height: 19px;" id="insInitDateU" name="insInitDateU" value=""/></td>
											</tr>											
											<!-- tr>
												<th>증서파일</th>
