...
<div class="wrap p-20 h-100">
	<div class="float_left w100p n posi_r">
	...
	<div class="lay-boxItem lay-item--full grids__col-12 m-0" style="overflow: auto;height:calc(100% - 90px);">
		<div class="boxItem__inner h-100">
			<div class="d-flex flex-7 h-100 flex-wrap">
				<div id="grid" class="float_left flex-10 w100p ov-auto-y ov-hidden-x" style="height:50%;border: 1px solid #e8eef1;  border-radius: 3px; padding: 10px;">
									...
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--200" id="authId" name="authId" value="" caption="권한ID" required="required" readonly="readonly"/>
											</div>
										</td>
										<th>권한명</th>
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--200" id="authNm" name="authNm" value="" caption="권한명" required="required"/>
											</div>
										</td>
										<th>권한설명</th>
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--200" id="authorDc" name="authorDc" value="" caption="권한설명"/>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="el-form custom-input">
												<input type="text" class="el-form__input el-form-width--200" id="dispOrdr" name="dispOrdr" value="" caption="정렬순서" required="required"/>
											</div>
										</td>
										<th>사용여부</th>
										<td colspan="3">
