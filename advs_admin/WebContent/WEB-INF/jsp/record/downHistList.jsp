...
// 	{ label: '평가점수',		name: 'evalPoint',		width: 60,	align: "center" },
	{ label: '다운일시',		name: 'regDateView',	width: 80,	align: "center" },
//	{ label: '업로드기관',	name: 'agencyName',			width: 150,	align: "center" },
	{ label: '다운로드기관',	name: 'agencyName',			width: 150,	align: "center" },
...
<div class="wrap p-20 h-100">
	<div class="float_left w100p b posi_r">
		...
		<form id="searchForm" name="searchForm" method="post">
			...
			<div class="d-flex align-center posi_r">
				...
				<fieldset class="d-flex align-center ml-20">
					<span class="tit el-txt fw-500">다운로드 일시</span>
