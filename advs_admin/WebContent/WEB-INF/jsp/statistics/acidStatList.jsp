...
var colModel_mon = [
	...
	{ name: 'm01', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm02', align: 'center'},{ name: 'm03', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm04', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	{ name: 'm05', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm06', align: 'center'},{ name: 'm07', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm08', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	{ name: 'm09', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm10', align: 'center'},{ name: 'm11', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'm12', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
...
function getSevletUrl() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectAcidStatSemiAnnualList.do';
	}
	return url;
}
...
function getSevletUrlChart() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectAcidStatSemiAnnualListChart.do';
	}
	return url;
}
...
function getSevletUrlExcel() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectAcidStatSemiAnnualExcel.do';
	}
	return url;
}
...
<div class="wrap p-20 h-100">
	<div class="float_left w100p g posi_r">
		...
		<form id="searchForm" name="searchForm" method="post">
			...
			<div class="d-flex align-center posi_r">
				<fieldset class="d-flex align-center">
					<span class="tit el-txt fw-500" style="float: left;">구분</span>
