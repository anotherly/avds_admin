...
function getSevletUrl() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectControlStatSemiAnnualList.do';
	}
	return url;
}
...
function getSevletUrlChart() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectControlStatSemiAnnualListChart.do';
	}
	return url;
}
...
function getSevletUrlExcel() {
	...
	if($('#sTerm').val() == 'MON'){
		...
		url = '/statistics/stat/selectControlStatSemiAnnualExcel.do';
	}
	return url;
}
...
<div class="wrap p-20 h-100">
	<div class="float_left w100p i posi_r">
	...
	<div class="lay-boxItem lay-item--full grids__col-12 m-0" style="overflow: auto;height:calc(100% - 90px);">
		<div class="boxItem__inner h-100">
			<div class="d-flex h-100 flex-wrap">
				<div id="grid" class="float_left w100p flex-10 ov-auto-y ov-hidden-x" style="height:50%;padding:10px;border:1px solid #e8eef1;border-radius:3px; ">
					<table id="gridList"></table>
				</div>
			
				<div id="form" class="form_box flex-10" style="overflow:auto;height: calc(50% - 5px);margin-top:5px;border:1px solid #e8eef1;border-radius:3px;">
