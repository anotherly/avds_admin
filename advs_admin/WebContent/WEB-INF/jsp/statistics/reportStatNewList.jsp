...
// grid column 구조
var colNm_mon_1 = ['임시운행기관','임시운행 등록번호','총주행거리','자율모드','일반모드','총주행거리','자율모드','일반모드','1월','2월','3월','4월','5월','6월','합계','1월','2월','월3','4월','5월','6월','합계'];
var colNm_mon_2 = ['임시운행기관','임시운행 등록번호','총주행거리','자율모드','일반모드','총주행거리','자율모드','일반모드','7월','8월','9월','10월','11월','12월','합계','7월','8월','9월','10월','11월','12월','합계'];
var colModel_mon = [
	{ name: 'trn', width: 250, align: 'center' }, { name: 'tmpRaceNumber', width: 250, align: 'center' },
	{ name: 'lastTotalDrivingDist', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'lastAutoDrivingDist', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'lastNomalDrivingDist', align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	...
	{ name: 'autoDrivingDist1', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'autoDrivingDist2', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'autoDrivingDist3', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	{ name: 'autoDrivingDist4', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'autoDrivingDist5', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'autoDrivingDist6', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}}, { name: 'autoDrivingSum', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	{ name: 'ctrChangeCnt1', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'ctrChangeCnt2', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'ctrChangeCnt3', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},
	{ name: 'ctrChangeCnt4', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'ctrChangeCnt5', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}},{ name: 'ctrChangeCnt6', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}}, { name: 'ctrChangeSum', width: 80, align: 'center', formatter : 'integer',  formatoptions : {defaultValue: '', thousandsSeparator : ','}}
];
...
function getSevletUrl() {
	var url = '/statistics/stat/selectReportStatNewList.do';
...
function fn_makeGrid() {
	...
	var lastStr;
	if(selTerm == '01'){
		lastStr = ($('#sKeyword').val() - 1) + '년';
		lastStr += ' 하반기까지'
	}
	else if(selTerm == '07'){
		lastStr = $('#sKeyword').val() + '년';
		lastStr += ' 상반기까지'
	}
	...
	$("#gridList").jqGrid('setGroupHeaders', {
		useColSpanStyle: true,
			groupHeaders:[
				{ startColumnName: colModel[2].name, numberOfColumns: 3, titleText: lastStr + " 누적치" },
				{ startColumnName: colModel[5].name, numberOfColumns: 3, titleText: str + "주행거리" },
				{ startColumnName: colModel[8].name, numberOfColumns: 7, titleText: str + "월별 자율주행 주행거리" },
				{ startColumnName: colModel[15].name, numberOfColumns: 7, titleText: str + "제어권 전환 횟수" }
		  ]
  });
...
function fn_excel() {
	...
	$('#excelFileNm').val('Report_statistics_excel.xls');
	
	$('#searchForm').attr('action', '/statistics/stat/selectReportStatNewExcel.do');
	$('#searchForm').submit();
}
